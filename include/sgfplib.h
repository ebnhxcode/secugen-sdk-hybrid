...
enum SGFDxDeviceName
{
	...
	SG_DEV_FDU06 = 0x07,	// HUPx
	SG_DEV_FDU07 = 0x08,	// HU10
	SG_DEV_AUTO = 0xFF,
};
...
struct SGFPM
{
   ...
   //12/05/2016
   virtual DWORD WINAPI WSQDecode(
                           BYTE **fingerImageOut,
                           DWORD *width,
                           DWORD *height,
                           DWORD *pixelDepth,
                           ...
                           DWORD *lossyFlag,
                           BYTE *wsqImage,
                           DWORD wsqImageLength) = 0;

   //12/05/2016
   virtual DWORD WINAPI WSQEncode(
                           BYTE ** wsqImageOut,
...
//12/05/2016
SGFPM_DLL_DECL DWORD WINAPI SGFPM_WSQDecode(
						HSGFPM hFpm,
                        BYTE **fingerImageOut,
                        DWORD *width,
                        DWORD *height,
...
//12/05/2016
SGFPM_DLL_DECL DWORD WINAPI SGFPM_WSQEncode(
						HSGFPM hFpm,
                        BYTE ** wsqImageOut,
                        DWORD *wsqImageOutSize,
                        float wsqBitRate,
